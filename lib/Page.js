...
class Page extends EventEmitter {
  ...
  async _onConsoleAPI(event) {
    ...
    if (!this.listenerCount(Page.Events.Console) && !this.listenerCount(Page.Events.ConsoleWithType)) {
    ...
    if (this.listenerCount(Page.Events.ConsoleWithType)) {
      this.emit(Page.Events.ConsoleWithType, {type: event.type, values});
    }
  }
...
Page.Events = {
  Console: 'console',
  ConsoleWithType: 'consoleWithType',
  Dialog: 'dialog',
  Error: 'error',
